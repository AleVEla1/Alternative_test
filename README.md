...
Описание задачи
Это консольное приложение "Строковый калькулятор". Приложение читает из консоли введенные пользователем строки, числа, арифметические операции, проводимые между ними, и выводит в консоль результат их выполнения. Калькулятор написан только с использованием встроенных библиотек golang, без применения готовых решений.
